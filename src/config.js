...
export const TMDB_TRAILER_FUNC = videoId => `http://api.themoviedb.org/3/movie/${videoId}/videos${TMDB_API_KEY}`;
export const TMDB_DETAILS_FUNC = videoId => `http://api.themoviedb.org/3/movie/${videoId}/videos${TMDB_API_KEY}&append_to_response=videos`;
